...
__all__ = [
    'U2NETDD_HEIGHT4_LITE',
    "U2NETDD_HEIGHT4_FULL",
    "U2NETDD_HEIGHT6_LITE",
    "U2NETDD_HEIGHT6_FULL",
    "U2NETDD_HEIGHT4_LITE_REPVGG",
    "U2NETDD_HEIGHT4_FULL_REPVGG",
    "U2NETDD_HEIGHT6_LITE_REPVGG",
    "U2NETDD_HEIGHT6_FULL_REPVGG",
    "U2NETDD_HEIGHT4_FULL2",
]
...
CONFIG_HEIGHT4_FULL = {
    ...
    'stage1': ('En_1', (7, 3, 32, 64), None),
    'stage2': ('En_2', (6, 64, 32, 128), None),
    'stage3': ('En_3', (5, 128, 64, 128), None),
    'stage4': ('En_4', (4, 128, 64, 128), 128),
    'stage3d': ('De_3', (5, 256, 64, 128), 128),
    'stage2d': ('De_2', (6, 256, 32, 64), 64),
    'stage1d': ('De_1', (7, 128, 16, 64), 64),
}

CONFIG_HEIGHT4_FULL2 = {
    # cfgs for building RSUs and sides
    # {stage : [name, (height(L), in_ch, mid_ch, out_ch, dilated), side]}
    'stage1': ('En_1', (3, 3, 64, 128), None),
    'stage2': ('En_2', (3, 128, 64, 128), None),
    'stage3': ('En_3', (2, 128, 64, 128), 128),
    'stage2d': ('De_2', (3, 256, 64, 128), 128),
    'stage1d': ('De_1', (3, 256, 64, 128), 128),
}

CONFIG_HEIGHT4_FULL3 = {
    # cfgs for building RSUs and sides
    # {stage : [name, (height(L), in_ch, mid_ch, out_ch, dilated), side]}
    'stage1': ('En_1', (3, 3, 32, 64), None),
    'stage2': ('En_2', (3, 64, 32, 64), None),
    'stage3': ('En_3', (2, 64, 32, 64), 64),
    'stage2d': ('De_2', (3, 128, 32, 64), 64),
    'stage1d': ('De_1', (3, 128, 32, 64), 64),
}
...
CONFIG_HEIGHT4_FULL_REPVGG = {
    # cfgs for building RSUs and sides
    # {stage : [name, (height(L), in_ch, mid_ch, out_ch, dilated), side]}
    'stage1': ('En_1', (7, 3, 32, 64, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage2': ('En_2', (6, 64, 32, 128, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage3': ('En_3', (5, 128, 64, 128, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage4': ('En_4', (4, 128, 64, 128, False, BASIC_BLOCK_REPVGG_NAME), 128),
    'stage3d': ('De_3', (5, 256, 64, 128, False, BASIC_BLOCK_REPVGG_NAME), 128),
    'stage2d': ('De_2', (6, 256, 32, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
...
CONFIG_HEIGHT6_LITE_REPVGG = {
    # cfgs for building RSUs and sides
    # {stage : [name, (height(L), in_ch, mid_ch, out_ch, dilated), side]}
    'stage1': ('En_1', (7, 3, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage2': ('En_2', (6, 64, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage3': ('En_3', (5, 64, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage4': ('En_4', (4, 64, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage5': ('En_5', (4, 64, 16, 64, True, BASIC_BLOCK_REPVGG_NAME), None),
    'stage6': ('En_6', (4, 64, 16, 64, True, BASIC_BLOCK_REPVGG_NAME), 64),
    'stage5d': ('De_5', (4, 128, 16, 64, True, BASIC_BLOCK_REPVGG_NAME), 64),
    'stage4d': ('De_4', (4, 128, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
    'stage3d': ('De_3', (5, 128, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
    'stage2d': ('De_2', (6, 128, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
    'stage1d': ('De_1', (7, 128, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
}

CONFIG_HEIGHT6_FULL_REPVGG = {
    # cfgs for building RSUs and sides
    # {stage : [name, (height(L), in_ch, mid_ch, out_ch, dilated), side]}
    'stage1': ('En_1', (7, 3, 32, 64, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage2': ('En_2', (6, 64, 32, 128, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage3': ('En_3', (5, 128, 64, 256, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage4': ('En_4', (4, 256, 128, 512, False, BASIC_BLOCK_REPVGG_NAME), None),
    'stage5': ('En_5', (4, 512, 256, 512, True, BASIC_BLOCK_REPVGG_NAME), None),
    'stage6': ('En_6', (4, 512, 256, 512, True, BASIC_BLOCK_REPVGG_NAME), 512),
    'stage5d': ('De_5', (4, 1024, 256, 512, True, BASIC_BLOCK_REPVGG_NAME), 512),
    'stage4d': ('De_4', (4, 1024, 128, 256, False, BASIC_BLOCK_REPVGG_NAME), 256),
    'stage3d': ('De_3', (5, 512, 64, 128, False, BASIC_BLOCK_REPVGG_NAME), 128),
    'stage2d': ('De_2', (6, 256, 32, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
    'stage1d': ('De_1', (7, 128, 16, 64, False, BASIC_BLOCK_REPVGG_NAME), 64),
}
...
class U2NETDD(FCDDNet):
    ...
    def __init__(self, in_shape: Tuple[int, int, int], config, bias=False):
        ...
        super(U2NETDD, self).__init__(in_shape=in_shape, bias=bias)
        ...
        # build fuse layer
        outconv = nn.Conv2d(int(self.height), 1, 1, bias=self.bias)
        self.add_module(OUTCONV_NAME, outconv)
        
    def forward(self, inputs, return_all_maps=False):
        ...
        def unet(x, height_=1):
            ...
            side_conv = getattr(self, rsu_side_name(height_))
            xside = F.leaky_relu(side_conv(x))  # this leaky relu was not in t u2net
            xside = nn.Upsample(
                size=sizes[1], 
                mode='bilinear', 
                align_corners=False,
        ...
        maps.reverse()
        maps_tensor = torch.cat(maps, 1)
        fuseconv = getattr(self, OUTCONV_NAME)
        # fused = fuseconv(maps_tensor)
        fused = F.leaky_relu(fuseconv(maps_tensor))  # this leaky relu was not in t u2net
        maps.insert(0, fused)
        maps_tensor = torch.cat(maps, 1)  # fused, height 1, height 2, ..., height n
        
        # return maps[0] # the fused
        if return_all_maps:
            return maps_tensor
        else:        
            return maps[1] # last map, not the fused
...
class U2NETDD_HEIGHT4_LITE(U2NETDD):
...
class U2NETDD_HEIGHT4_FULL(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT4_FULL)


class U2NETDD_HEIGHT6_FULL(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT6_FULL)
       

class U2NETDD_HEIGHT6_LITE(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT6_LITE)
       

class U2NETDD_HEIGHT4_LITE_REPVGG(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT4_LITE_REPVGG)
       

class U2NETDD_HEIGHT6_LITE_REPVGG(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT6_LITE_REPVGG)
       

class U2NETDD_HEIGHT4_FULL_REPVGG(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT4_FULL_REPVGG)
       

class U2NETDD_HEIGHT6_FULL_REPVGG(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT6_FULL_REPVGG)
       

class U2NETDD_HEIGHT4_FULL2(U2NETDD):
    
    def __init__(self, in_shape: Tuple[int, int, int], bias=False, ):
        super().__init__(in_shape=in_shape, bias=bias, config=CONFIG_HEIGHT4_FULL2)
       
       

if __name__ == '__main__':
    # model = U2NETDD_HEIGHT4_FULL(
    # model = U2NETDD_HEIGHT6_FULL(
    # model = U2NETDD_HEIGHT6_LITE_REPVGG(
    model = U2NETDD_HEIGHT4_LITE_REPVGG(
        in_shape=(3, 64, 64),
        bias=True,
    )
    print(model)
